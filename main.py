...
def get_batch_comment_counts(slugs: tuple) -> dict:
    """Return a mapping from post slug to internal comment counts.
    ...
    try:
        ...
        pipeline = [
            {'$match': {'post_slug': {'$in': list(slugs)}, 'is_deleted': False}},
...
def prepare_posts(posts):
    ...
    counts_map = get_batch_comment_counts(tuple(sorted(slugs)))
